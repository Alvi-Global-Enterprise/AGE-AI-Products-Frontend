...
6. [Endpoint Reference: Duewise (Invoice Management, AI & Collections)](#6-endpoint-reference-duewise-invoice-management-ai--collections)
    - **6.1 Dashboard, Entitlements & Cash Flow Forecast**
   ...
   - **6.4 Unified Accounts & Integrations Status (QuickBooks + Stripe)**
     - [`GET /api/accounts/status` (or `/api/duewise/accounts/status`)](#get-apiaccountsstatus)
   - **6.5 Monthly Recovery Fee Engine (Base 15% vs Big Books 10%)**
   ...
   - **6.6 Public Communication Tracking (No Auth)**
   ...
   - **6.7 Public Invoice Payment Portal & Stripe Checkout (No Auth)**
...
### 6.4 Unified Accounts & Integrations Status (QuickBooks Online + Stripe Connect)
  ...
  "data": [
    {
      ...
      "fee_amount": 2250.0,
      "status": "paid",
      "stripe_invoice_id": "in_1Px9...",
      "charged_at": "2026-09-01T00:05:00.000000Z"
    }
  ],
  "current_page": 1,
  "per_page": 15,
...
### 6.7 Public Invoice Payment Portal & Stripe Checkout (No Auth / Client Facing)
...
export interface DuewiseEntitlementsResponse {
  data: DuewisePlanLimits;
}
